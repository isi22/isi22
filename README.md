...
<td width="50%" valign="top">
    <div style="background-color: rgba(215, 215, 215, 0.2); border-radius: 15px; padding: 0px;">
      <details>
        ...
        <td style="height: 400px;">
          <a href="https://github.com/isi22/Monzo-Apple-Shortcut/blob/main/README.md" target="_blank">
            <div style="height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
              <img src="https://raw.githubusercontent.com/isi22/Monzo-Apple-Shortcut/main/Images/thumbnail.png" alt="🏷️ Smart Monzo Transaction Tags (iOS Shortcuts & IFTTT)" style="max-width: 100%; max-height: 100%;">
            </div>
          </a>
          <br>
          <h3>🏷️ Smart Monzo Transaction Tags (iOS Shortcuts & IFTTT)</h3>
          <p align="left">
      ...
      <tr>
        <td style="height: 400px;">
          <a href="https://github.com/isi22/Tube-Departure-Board/blob/main/README.md" target="_blank">
            <div style="height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
              <img src="https://raw.githubusercontent.com/isi22/Tube-Departure-Board/main/Images/banner.jpg" alt="🚇 Tube Departure Board for Raspberry Pi" style="max-width: 100%; max-height: 100%;">
            </div>
          </a>
          <br>
          <h3>🚇 Tube Departure Board for Raspberry Pi</h3>
          <p align="left">
      ...
      <tr>
        <td style="height: 400px;">
          <a href="https://nbviewer.org/github/isi22/IBM_AI_Engineering_Professional_Certificate/blob/main/Crack_Detection.ipynb" target="_blank">
            <div style="height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
              <img src="https://raw.githubusercontent.com/isi22/IBM_AI_Engineering_Professional_Certificate/main/Images/crack_detection_thumbnail.png" alt="Crack Detection" style="max-width: 100%; max-height: 100%;">
            </div>
          </a>
          <br>
      ...
      <tr>
        <td style="height: 400px;">
          <a href="https://nbviewer.org/github/isi22/IBM_AI_Engineering_Professional_Certificate/blob/main/LangChain_QA_Bot.ipynb" target="_blank">
            <div style="height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
              <img src="https://raw.githubusercontent.com/isi22/IBM_AI_Engineering_Professional_Certificate/main/Images/QA_bot_thumbnail.png" alt="QA Bot to Answer Questions from Loaded Documents" style="max-width: 100%; max-height: 100%;">
            </div>
          </a>
          <br>
          <h3>QA Bot to Answer Questions from Loaded Documents</h3>
          <p align="left">
      ...
      <tr>
        <td style="height: 400px;">
          <a href="https://nbviewer.org/github/isi22/IBM_AI_Engineering_Professional_Certificate/blob/main/Titanic_Survival_Prediction.ipynb" target="_blank">
            <div style="height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
              <img src="https://raw.githubusercontent.com/isi22/IBM_AI_Engineering_Professional_Certificate/main/Images/titanic_thumbnail.jpg" alt="Titanic Survival Prediction" style="max-width: 100%; max-height: 100%;">
            </div>
          </a>
          <br>
...
<img alt="Machinelearning" src="https://img.shields.io/badge/-Machine_Learning-333333.svg?logo=data:image/svg+xml;base64,&style=flat-square" />
 <img alt="Python" src="https://img.shields.io/badge/-Python-3776AB?logo=python&logoColor=white&style=flat-square" />
 <img alt="Scikit" src="https://img.shields.io/badge/-scikit--learn-F7931E?logo=scikit-learn&logoColor=white&style=flat-square" />
</p>
        </td>
      </tr>
    </table></summary>
      ...
      <tr>
        <td style="height: 400px;">
          <a href="https://nbviewer.org/github/isi22/IBM_AI_Engineering_Professional_Certificate/blob/main/Waste_Classification.ipynb" target="_blank">
            <div style="height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
              <img src="https://raw.githubusercontent.com/isi22/IBM_AI_Engineering_Professional_Certificate/main/Images/waste_classification_thumbnail.png" alt="Waste Classification" style="max-width: 100%; max-height: 100%;">
            </div>
          </a>
          <br>
